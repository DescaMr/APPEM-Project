              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h2 class="h4 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat</h2>
                    <br><br>
                  </div>
                  ...
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                      <input type="number" name="telp" class="form-control form-control-user" placeholder="Masukan No Telepon...">
                    </div>
                  ...
                  <div class="text-center">
                    ...
                    <a class="small" href="index.php">Masuk Akun!</a>
                  </div>
                  <hr>
